...
Camera::Camera( Vec3 i_look_from,
                Vec3 i_look_at,
                Vec3 i_vup,
                float i_vfov,
                float i_aspect )
...
DepthCamera::DepthCamera( Vec3 i_look_from,
                          Vec3 i_look_at,
                          Vec3 i_vup,
                          float i_vfov,
                          float i_aspect,
    ...
    : Camera()
{
    ...
    m_v = cross( m_w, m_u );
    m_lowerLeftCorner = m_origin - half_width * i_focus_dist * m_u
                        - half_height * i_focus_dist * m_v - i_focus_dist * m_w;
