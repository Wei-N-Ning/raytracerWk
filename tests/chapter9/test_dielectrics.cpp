...
void dielectric(const char* filename) {
    ...
    render.m_entities.push_back(new Sphere(
        Vec3(-1, 0, -1), 0.5f, render.m_materials.at("dielectric")));

    render.m_entities.push_back(new Sphere(
        Vec3(-1, 0, -1), -0.45f, render.m_materials.at("dielectric")));
